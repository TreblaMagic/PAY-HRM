...
export function generateAttendancePDF(
  ...
  try {
    ...
    console.log('PDF Generator - Document created');
    ...
    console.log('PDF Generator - Table data prepared:', tableData.length, 'rows');
    ...
    console.log('PDF Generator - Table generated');
